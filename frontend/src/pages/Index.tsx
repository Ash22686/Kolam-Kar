  ...
  const features = [
    {
      title: "Analyser",
      description:
        "Upload your Kolam designs for a detailed analysis of patterns, symmetry, and cultural significance.",
    ...
    },
    {
      title: "Generator",
      description:
        "Create stunning Kolam designs using AI from text prompts or by transforming existing images.",
    ...
    },
    {
      title: "Playground",
      description:
        "An interactive canvas to draw your own Kolam patterns with real-time symmetry assistance.",
      ...
      <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-30 container mx-auto px-4 lg:px-6 animate-fade-in">
          ...
          <p className="text-lg lg:text-x mb-8 leading-relaxed max-w-2xl mx-auto block gradient-lotus bg-clip-text text-transparent mt-2">
            Experience the timeless beauty of Kolam, powered by artificial
            intelligence.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="gradient-lotus text-white border-0 shadow-lotus hover:shadow-glow transition-all"
            >
              Get Started
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our comprehensive suite of tools helps you explore the beautiful
              world of Kolam art, whether you're a beginner or an expert.
            </p>
          </div>
